...
data-i18n='modbus-contrib.label.server'></span></label> <input type='text' id='node-input-server'> </div> 
<!-- <hr>
    <div class="form-row">
 ...
 <hr> <div class='form-row'> <label style='min-width:160px' for='node-input-showStatusActivities'><i class='fa fa-th'>
</i> <span data-i18n='modbus-contrib.label.showActivities'></span></label> <input type='checkbox' 
...
</script> <script type='text/x-red' data-help-name='modbus-flex-connector'>
