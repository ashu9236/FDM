...
for='node-config-input-tcpType'><i class='icon-bookmark'></i> <span 
data-i18n='modbus-contrib.label
            .tcpType'></span></label> <select type='text' 
id='node-config-input-tcpType' style='width:140px'> <option value='DEFAULT' select>DEFAULT</option> <option 
value='TPC-RTU-BUFFERED'>RTU-BUFFERED</option> <option value='TELNET'>TELNET</option> <option value='C701'>C701
</option> </select> </div> </div> <div id='node-inputs-modbus-serial'> <div class='form-row'> <label 
...
placeholder='1' style='max-width:80px'> </div> 
